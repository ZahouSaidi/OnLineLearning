<!DOCTYPE html>
    ...
    min-height: 100vh; /* Définit la hauteur minimale de la page à 100% de la hauteur de la fenêtre visible */
}
/* Footer Styles */
    .footer-container {
      display: flex;
...
footer {
    ...
    padding: 20px;
    text-align: center;
    margin-top: auto; /* Le footer est toujours en bas de la page */
}
...
.document-list {
    ...
    padding: 20px;
    flex: 1; /* Le contenu s'étend pour remplir l'espace restant */
    display: flex;
    flex-direction: column;
